...
//Written by the Vibhuthi and Vihanga from here onwards
//Declaring fucntions
extern int execute_cmdtype(SHELLCMD *t);
extern int execute_time(SHELLCMD *t);
extern int execute_cd(SHELLCMD *t);
extern void execute_exit(SHELLCMD *t);
extern int execute_external(SHELLCMD *t);
extern int execute_search(SHELLCMD *t);
